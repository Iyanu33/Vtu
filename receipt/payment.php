...
$sql = "SELECT id,amount,status,fee,reg_date FROM payment WHERE id ='$id'";
...
$logo = "../uploads/".$webConfig["webLogo"];
$barcode = 'https://chart.googleapis.com/chart?chs=300x300&cht=qr&chl='.$webLink.'/payment/view.php?id='.$id;
...
$pdf->Cell(0,8,$LANG["wallet_funding"],"R,B,T",1,"L");
