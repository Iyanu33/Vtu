...
$rexgSerarch =  explode(' ',$q);   
$rexgSerarch  =  implode('|',$rexgSerarch );
...
$stop = $pageData["stop"];
    ...
    $sql = "SELECT id,image,display_name FROM service WHERE display_name REGEXP '$rexgSerarch' OR name REGEXP '$rexgSerarch' AND active='1'  ORDER BY hit ASC LIMIT $start,$stop";
