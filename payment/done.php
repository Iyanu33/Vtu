...
if(!empty($_GET["recharge"])){
    ...
    if($result->num_rows > 0){
        ...
        if($status=="success"){
            $refer = xcape($conn, $_SESSION["refer"]);
           $transaction = payService($conn, $transactionId,$refer);
           if($transaction===true){
    ...
    $link="payment";
    $transactionId = xcape($conn, $_GET["id"]);
}
            ...
            <div class="section row "  >
                  ...
                  <div class="row col s12 m12 l12 custom-form-control ">
                    <div id="payCard" class="card-panel   hoverable ">
                       ...
                       <?php }?>
                        <a href="../<?php echo $link; ?>/view.php?id=<?php echo $transactionId; ?>" <button class="btn waves-effect waves-green right"><?php echo $LANG["continue"];?></button></a>
