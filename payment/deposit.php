  ...
  <section id="content">
          ...
          <div class="container">
            <div class="section">
                ...
                <p class="left"><?php echo $LANG["deposit"]; ?> </p> 
...
$totalQuery = $conn->query("SELECT id FROM pay_noti WHERE  owner='$loginUser'")->num_rows;
$pageData = $page->getData($currentPage,$totalQuery);
$start = $pageData["start"];
$stop = $pageData["stop"];
//refresh
$sql = "SELECT reg_date,status,id,amount FROM pay_noti WHERE owner='$loginUser' LIMIT $start,$stop";
