...
$totalQuery = $conn->query("SELECT id FROM recharge WHERE  user='$loginUser'")->num_rows;
$page->searchForm($action);
$pageData = $page->getData($currentPage,$totalQuery);
$start = $pageData["start"];
$stop = $pageData["stop"];

$sql = "SELECT service_id,id,payment_method,amount,status FROM recharge WHERE user='$loginUser' LIMIT $start,$stop";
