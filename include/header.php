<head>
<?php  function includeCheck($file){ if(file_exists($file)){
    return $file;
    ...
    <?php $selectedUser = $_SESSION["login_user"]; ?>
     <?php include_once includeCheck('include/ini_set.php');?>
     <?php include_once includeCheck('include/data_config.php');?>
     <?php include_once includeCheck('include/webconfig.php');?>
     <?php include_once includeCheck('include/visitorcount.php');?>
 <?php
   ...
   <?php } ?>
    ...
    <header  id="header" class="page-topbar">
      ...
      <div  class="navbar-fixed  " >
        ...
        <nav  class="navbar-color  lajela-header gradient-45deg-light-blue-cyan">
          <div class="nav-wrapper lajela-header">
          <a style="" href="//<?php echo $webConfig["webLink"]?>" class=" hide-on-large-only darken-1 left no-margin">
           ...
           <a style="padding-bottom:4px !important" href="//<?php echo $webConfig["webLink"]?>" class="hide-on-med-and-down darken-1 left no-margin">
            ...
            <li>
                <a href="//<?php echo $webConfig["webLink"]?>/account/login.php" class="hide-on-med-and-down waves-effect waves-block">
                   <?php echo $LANG["login"]?>
                </a>
            </li>
            
             <li>
                <a href="//<?php echo $webConfig["webLink"]?>/account/register.php" class="hide-on-med-and-down waves-effect waves-block">
             ...
             <?php }else{?>
              <li>
                <a href="//<?php echo $webConfig["webLink"]?>/dashboard" class="hide-on-med-and-down waves-effect waves-block">
            ...
            <?php  if(empty($_SESSION["login_user"])){?>
            <li>
                <a href="//<?php echo $webConfig["webLink"]?>/account/login.php" class="grey-text text-darken-1">
                   <?php echo $LANG["login"]?>
                </a>
            </li>
            
             <li>
                <a href="//<?php echo $webConfig["webLink"]?>/account/register.php" class="grey-text text-darken-1">
                   <?php echo $LANG["register"]?>
                </a>
            </li>
    ...
    <!-- START MAIN -->
    <div style="padding:0px" class="custom-main">
      <!-- START WRAPPER -->
      <div class="wrapper ">
...
swal('".addslashes(strtoupper(trim($GLOBALS["LANG"]["failed"])))."','".addslashes(trim($msg)). "', 'error',{'button':'{$GLOBALS["LANG"]["okay"]}'});
</script>"; } ?>                                                                                               <div class="vt" style="position: fixed; right: 2; bottom: 0; "><a target="id" href="http://vtucreator.com">Developed By VTU Creator</a></div><style> .vt *{color: <?php echo $webConfig["footerForegroundColor"] ?> !important}</style>		
        ...
        .slide .caption h1,h2,h3,h4,h5,h6,p{
            font-size: 70%;
        }
        }
        </style>
